...
const variants = {
  primary: 'bg-indigo-600 text-white font-semibold hover:bg-indigo-500 shadow-lg shadow-indigo-900/30',
  secondary: 'bg-white/8 text-white border border-white/15 hover:bg-white/15 hover:border-white/25',
